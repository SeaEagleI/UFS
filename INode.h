...
public:
    ...
    static const unsigned int IRWXG = 0x08;			    /* 文件主同组用户对文件的读、写、执行权限 */
    static const unsigned int IRWXO = 0x01;			    /* 其他用户对文件的读、写、执行权限 */
    static const unsigned int IRWX = (IRWXU | IRWXG | IRWXO);			    /* 其他用户对文件的读、写、执行权限 */
    static const unsigned int MASK = 0xFFFFFFCF;			    /* 其他用户对文件的读、写、执行权限 */
...
public:
    ...
    string  i_uname;        // override for i_uid
...
public:
    ...
    string  d_uname;        // override for d_uid
