...
void man(string command) {
    ...
    static string delet =
            ...
            "Error Avoided :  非普通文件，文件名过长，目录路径不存在，目录超出根目录等 \n"
    ;

    static string rmdir =
            "Command       :  rmdir -删除文件夹 \n"
            "Description   :  删除一个文件夹。若出现错误，会有相应错误提示! \n"
            "Usage         :  delete <文件夹名> \n"
            "Parameter     :  <文件夹名> 可以包含相对路径或绝对路径 \n"
            "Error Avoided :  非文件夹，文件夹名过长，文件夹路径不存在，目录超出根目录等 \n"
    ;
    ...
    static string seek =
            "Command       :  seek -移动读写指针 \n"
            "Description   :  类Unix|Linux函数fseek，移动当前一个已经打开的文件的读写指针。若出现错误，会有相应错误提示! \n"
            "Usage         :  seek <file descriptor> <offset> <origin> \n"
            "Parameter     :  <file descriptor> open返回的文件描述符 \n"
            "                 <offset> 指定目的位置，表示目标位置与起始位置<origin>间的偏移量 可正可负 \n"
    ...
    static string write =
            "Command       :  write -写入文件 \n"
            "Description   :  类Unix|Linux函数write，将指定内容写入一个已经打开的文件中。若出现错误，会有相应错误提示! \n"
    ...
    static string read =
            ...
            "Parameter     :  <file descriptor> open返回的文件描述符 \n"
            "                 [-o <OutFileName>] -o 指定输出方式为文件，文件名为 <OutFileName> 不指定-o参数时默认输出到shell \n"
    ...
    static string history =
            "Command       :  history -获取历史命令 \n"
            "Description   :  打印全部历史命令 \n"
            "Usage         :  history \n"
            "Usage Demo    :  history \n"
            "Error Avoided :  history文件损坏而导致的读取失败 \n"
    ;

    static string stat =
            "Command       :  stat -获取文件详情 \n"
            "Description   :  获取指定文件的文件大小等详细信息 \n"
            "Usage         :  stat <文件夹名> \n"
            "Parameter     :  <文件名> 可以包含绝对路径或本目录下文件 \n"
            "Error Avoided :  文件夹名过长，文件夹路径不存在，目录超出根目录等 \n"
    ;
